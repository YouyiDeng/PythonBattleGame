...
class Sorcerer(Character):
    ...
    def __init__(self, name: str, bq: 'BattleQueue', ps: 'Playstyle') -> None:
        ...
        self._defense = 10
        self.set_skill_decision_tree(create_default_tree())

    def set_skill_decision_tree(self, sdt: SkillDecisionTree) -> None:
        """
        Set self's Attack Skill based on SkillDecisionTree sdt.
        ...
        >>> c.enemy = c2
        >>> c2.enemy = c
        >>> c.set_skill_decision_tree(create_default_tree())
        >>> c.attack()
        >>> c
        s (Sorcerer): 100/85
        >>> c2
        s2 (Sorcerer): 90/100
        """
        self._skills['A'].set_decision_tree(sdt)
    ...
    def copy(self, new_battle_queue: 'BattleQueue') -> 'Sorcerer':
        ...
        >>> c2.enemy = c
        >>> c.set_skill_decision_tree(create_default_tree())
        >>> c2.set_skill_decision_tree(create_default_tree())
        >>> c
        s (Sorcerer): 100/100
        >>> new_bq = BattleQueue()
        >>> c_copy = c.copy(new_bq)
        ...
        >>> c_copy.enemy = c2_copy
        >>> c2_copy.enemy = c_copy
        >>> c_copy.set_skill_decision_tree(create_default_tree())
        >>> c2_copy.set_skill_decision_tree(create_default_tree())
        >>> c_copy.attack()
        >>> c
        s (Sorcerer): 100/100
        >>> c_copy
