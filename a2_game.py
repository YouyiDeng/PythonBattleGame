...
from a2_playstyle import ManualPlaystyle, RandomPlaystyle, \
    MinimaxRecursivePlaystyle, MinimaxIterativePlaystyle
...
PLAYSTYLE_CLASSES = {'m': ManualPlaystyle,
                     'r': RandomPlaystyle,
                     'mr': MinimaxRecursivePlaystyle,
                     'mi': MinimaxIterativePlaystyle
                    }
